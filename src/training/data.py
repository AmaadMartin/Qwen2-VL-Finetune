...
from data_conversion import convert_sources
...
class SupervisedDataset(Dataset):
    ...
    def __init__(
        ...
        if isinstance(data_path, str):
            list_data_dict = json.load(open(data_path, "r"))[:1]
        else:
            list_data_dict = data_path[:1]
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        # adding to convert sources to llava format
        sources = convert_sources(sources, K)
